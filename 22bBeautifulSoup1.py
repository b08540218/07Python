...
# '파이썬 웹크롤링'으로 검색한 인코딩 처리된 주소(한글로 넣어도 됨)
'''
%ED%8C%8C%EC%9D%B4%EC%8D%AC+%EC%9B%B9%ED%81%AC%EB%A1%A4%EB%A7%81
장마
'''
